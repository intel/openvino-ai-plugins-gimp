...
2. Clone, run install script and copy the stable-diffusion-1.5 models for VPU: <br>
   ...
   - Download & extract custom VPU compatible SD-1.5 models from - [stable-diffusion-1.5-internal-blobs-NEW](https://intel.sharepoint.com/:u:/r/sites/VPUIPProductPlanningExecution-CustomerSolutionsEngineering/Shared%20Documents/Customer%20Solutions%20Engineering/Demo_Material/Vision/2023/Demo%20Installers/GIMP-Optimized-min16gb_RAM/stable-diffusion-1.5-internal-blobs-NEW.zip?csf=1&web=1&e=DEclbr) and put the folder stable-diffusion-1.5-internal-blobs-NEW in the following location: <br>
...
4. For running on GPU & VPU - Select stable-diffusion-1.5-internal-blobs-NEW from the model drop down list and choose Text_encoder Device - CPU, Unet Device - GPU/VPUX, UnetNeg Device - VPUX/GPU, VAE Device - GPU <br>
