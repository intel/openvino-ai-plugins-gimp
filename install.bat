:<<BATCH
	...
	gimpenv3\Scripts\python.exe -m pip install  transformers>=4.21.1 diffusers==0.14.0 controlnet-aux>=0.0.6 tqdm==4.64.0 openvino==2022.3.0 huggingface_hub streamlit==1.12.0 watchdog==2.1.9 ftfy==6.1.1 | find /V "already satisfied"
