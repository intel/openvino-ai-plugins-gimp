...
def run(procedure, run_mode, image, n_drawables, layer, args, data):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        if n_layers == 2:
            model_list = list_models(config_path_output["weight_path"],"SD_1.5_Inpainting") + list_models(config_path_output["weight_path"],"SD_1.5_Inpainting_int8")
        else:
            model_list = list_models(config_path_output["weight_path"],"SD_1.4") + list_models(config_path_output["weight_path"],"SD_1.5") \
            + list_models(config_path_output["weight_path"],"controlnet_openpose") + list_models(config_path_output["weight_path"],"controlnet_openpose_int8") \
            + list_models(config_path_output["weight_path"],"controlnet_canny_int8") + list_models(config_path_output["weight_path"],"controlnet_canny") \
            + list_models(config_path_output["weight_path"],"controlnet_scribble") + list_models(config_path_output["weight_path"],"controlnet_scribble_int8")
