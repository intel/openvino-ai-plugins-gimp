...
try:
    ...
    print("OVDiffusionPipeline is unavailable; disabling sana/flux support")
    OVDiffusionPipeline = None
try:
    ...
    print("diffusers is unavailable; disabling tiny autoencoder support")
    OVModelVae = None
    OVModelVaeDecoder = None
    OVModelVaeEncoder = None
